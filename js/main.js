...
const swiper6 = new Swiper('.about-curse-container', {
   spaceBetween: 20,
   loop: true,
   slidesPerView: 1,
   grabCursor: true,
   pagination: {
      el: ".about-curse-container .swiper-pagination",
      type: "fraction",
   },

   navigation: {
      nextEl: ".about-curse-container .swiper-button-next1",
      prevEl: ".about-curse-container .swiper-button-prev1",
   },
